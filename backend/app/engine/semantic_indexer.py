...
class SemanticIndexer:
    ...
    def _need_to_build_index(self) -> bool:
        ...
        #TO DO: reimplement data pipeline
        return False
    ...
    def _get_vector_store_index(self):
        ...
        logging.log(logging.INFO, '===Get VectorStoreIndex=== members_and_build_updates using openai text-embedding-3-small dim 1536')
    ...
    def _add_nodes_to_vector_store_index(self, nodes: Sequence[BaseNode]):
        logging.log(logging.INFO, '===BUILD VECTOR STORE INDEX insert nodes into supabase === members_and_build_updates')
